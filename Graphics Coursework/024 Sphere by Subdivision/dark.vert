...
vec4[2] calculate_dark_directional(in directional_light light, in material mat, in vec3 normal, in vec3 view_dir)
{
	vec4 colour[2];
...
// point_light
vec4[2] calculate_dark_point(in point_light light, in material mat, in vec3 normal, in vec3 position, in vec3 view_dir){
	vec4 colour[2];
