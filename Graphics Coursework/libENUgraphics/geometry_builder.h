...
namespace graphics_framework
{
	...
	*/
	...
	public:
		...
		static geometry create_cylinder(const unsigned int stacks = 10, const unsigned int slices = 10, const glm::vec3 &dims = glm::vec3(1.0f, 1.0f, 1.0f));
		// Creates sphere geometry
		static geometry create_sphere(const unsigned int stacks = 10, const unsigned int slices = 10, const glm::vec3 &dims = glm::vec3(1.0f, 1.0f, 1.0f));
		...
		static geometry create_plane(const unsigned int width = 100, const unsigned int depth = 100, const float scale = 1.0f);
	};
}