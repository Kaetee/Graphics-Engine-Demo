...
namespace graphics_framework
{
	...
	bool renderer::initialise()
	{
        ...
        glfwWindowHint(GLFW_OPENGL_DEBUG_CONTEXT, GL_TRUE);
		_instance->_window = glfwCreateWindow(1920, 1080, "Render Framework", nullptr, nullptr);
		glfwSetWindowPos(_instance->_window, video_mode->width / 2 - 1920 / 2, video_mode->height / 2 - 1080 / 2);
		_instance->_width = 1920;
		_instance->_height = 1080;
#else
